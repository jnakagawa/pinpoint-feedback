...
Use **Share** in the in-page toolbar to copy a public review link. Anyone with that browser link can read, comment on, resolve, and reopen feedback without installing the extension or creating a Zero account.
